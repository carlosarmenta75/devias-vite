...
export function OrganizationsFilters({ filters = {}, sortDir = "desc" }) {
	const { email, phone, status } = filters;

	const navigate = useNavigate();

	const selection = useOrganizationsSelection();
	...
	const updateSearchParams = React.useCallback(
		(newFilters, newSortDir) => {
			...
			navigate(`${paths.dashboard.organizations.list}?${searchParams.toString()}`);
		},
		[navigate]
	);
